 ...
 * the hierarchy you must call {@link #setup(android.content.Context, android.support.v4.app.FragmentManager)}
 * to complete the initialization of the tab host.
 *
 */
public class SongsFragmentTabHost extends TabHost
...
public SongsFragmentTabHost(Context context) {
...
public SongsFragmentTabHost(Context context, AttributeSet attrs) {
    super(context, attrs);
